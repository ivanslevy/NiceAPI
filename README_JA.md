...
| ダッシュボード | プロバイダー | グループ |
| :---: | :---: | :---: |
| ![ダッシュボード](example/dashboard_ja.png) | ![プロバイダー](example/providers_ja.png) | ![グループ](example/groups_ja.png) |
| リアルタイムのAPI使用状況、成功率、パフォーマンスメトリクスを一目で監視します。 | 資格情報、コスト、強力なモデルインポーターなど、すべてのAIプロバイダーエンドポイントを管理します。 | 複数のプロバイダーをグループ化して、優先度ベースのフェイルオーバー機能を備えた仮想エンドポイントを作成します。 |
...
| 設定 |
| :---: |
| ![設定](example/settings_ja.png) |
| UI言語やフェイルオーバーの再試行ロジックなど、グローバル設定を構成します。 |
